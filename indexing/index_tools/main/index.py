...
def parse_args():
    ...
    parser.add_argument('--config_file', '-cfg', default='F:/PycharmProjects_/Graduation/indexing/index_configs/hw_json.yaml', metavar='FILE', type=str, help='path to config file')
...
# python3 main/index.py -cfg F:/PycharmProjects_/Graduation/indexing/index_configs/hw_json.yaml
# python3 main/single_index.py -cfg F:/PycharmProjects_/Graduation/indexing/index_configs/hw_json.yaml