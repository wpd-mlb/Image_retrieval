...
root_data="F:/PycharmProjects_/Graduation/features/data"
root_data_gallery=join(root_data,"test_data_A","gallery")
root_data_query=join(root_data,"test_data_A","query")
gallery_json=join('F:/PycharmProjects_/Graduation/indexing/PyRetri-master/data_jsons','huawei_A_gallery.json')
query_json=join('F:/PycharmProjects_/Graduation/indexing/PyRetri-master/data_jsons','huawei_A_query.json')
...
for img in list_name:
    dict_temp={}
    img_name_1=img.split("\\")[-1]
    img_name_2=os.path.splitext(img_name_1)[0]

    dict_temp['path']=img
    dict_temp['label']=img_name_1
    dict_temp['query_name']=img_name_2
    print(dict_temp)
